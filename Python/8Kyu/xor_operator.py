...
#  where a and b are the two expressions to be evaluated. Your xor function should have
#  the behaviour described above, returning true if exactly one of the two expressions evaluate to true, false otherwise.
